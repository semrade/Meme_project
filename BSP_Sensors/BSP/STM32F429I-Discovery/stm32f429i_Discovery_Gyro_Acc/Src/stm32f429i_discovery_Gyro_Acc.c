...
{	//adr          //Type	           //R/W
	...
	{.adr=0x05,    .type=0x03},        //r/w                        SENSOR_SYNC_RES_ RATIO
	...
	{.adr=0x1F,    .type=0xFF},        //-                          STATUS_SPIAux
	{.adr=0x20,    .type=0x02},        //r                          RESERVED
	{.adr=0x21,    .type=0x02},        //r                          OUT_TEMP_L
	{.adr=0x22,    .type=0x02},        //r                          OUT_TEMP_H
	{.adr=0x23,    .type=0x02},        //r                          OUTX_L_G
	{.adr=0x24,    .type=0x02},        //r                          OUTX_H_G
	{.adr=0x25,    .type=0x02},        //r                          OUTY_L_G
	{.adr=0x26,    .type=0x02},        //r                          OUTY_H_G
	{.adr=0x27,    .type=0x02},        //r                          OUTZ_L_G
	{.adr=0x28,    .type=0x02},        //r                          OUTZ_H_G
	{.adr=0x29,    .type=0x02},        //r                          OUTX_L_XL
	{.adr=0x2A,    .type=0x02},        //r                          OUTX_H_XL
	{.adr=0x2B,    .type=0x02},        //r                          OUTY_L_XL
	{.adr=0x2C,    .type=0x02},        //r                          OUTY_H_XL
	{.adr=0x2D,    .type=0x02},        //r                          OUTZ_L_XL
	{.adr=0x2E,    .type=0x02},        //r                          OUTZ_H_XL
	{.adr=0x2F,    .type=0x02},        //r                          SENSORHUB1_REG
	{.adr=0x30,    .type=0x02},        //r                          SENSORHUB2_REG
	{.adr=0x31,    .type=0x02},        //r                          SENSORHUB3_REG
	{.adr=0x32,    .type=0x02},        //r                          SENSORHUB4_REG
	{.adr=0x33,    .type=0x02},        //r                          SENSORHUB5_REG
	{.adr=0x34,    .type=0x02},        //r                          SENSORHUB6_REG
	{.adr=0x35,    .type=0x02},        //r                          SENSORHUB7_REG
	{.adr=0x36,    .type=0x02},        //r                          SENSORHUB8_REG
	{.adr=0x37,    .type=0x02},        //r                          SENSORHUB9_REG
	{.adr=0x38,    .type=0x02},        //r                          SENSORHUB10_REG
	{.adr=0x39,    .type=0x02},        //r                          SENSORHUB11_REG
	{.adr=0x3A,    .type=0x02},        //r                          SENSORHUB12_REG
	{.adr=0x3B,    .type=0x02},        //r                          FIFO_STATUS1
	{.adr=0x3C,    .type=0x02},        //r                          FIFO_STATUS2
	{.adr=0x3D,    .type=0x02},        //r                          FIFO_STATUS3
	{.adr=0x3E,    .type=0x02},        //r                          FIFO_STATUS4
	{.adr=0x3F,    .type=0x02},        //r                          FIFO_DATA_OUT_L
	{.adr=0x40,    .type=0x02},        //r                          FIFO_DATA_OUT_H
	{.adr=0x41,    .type=0x02},        //r                          TIMESTAMP0_REG
	{.adr=0x42,    .type=0x03},        //r/w                        TIMESTAMP1_REG
	{.adr=0x43,    .type=0xFF},        //-                          TIMESTAMP2_REG
	{.adr=0x4D,    .type=0x02},        //r                          RESERVED
	{.adr=0x4E,    .type=0x02},        //r                          SENSORHUB13_RE
	{.adr=0x4F,    .type=0x02},        //r                          SENSORHUB14_RE
	{.adr=0x50,    .type=0x02},        //r                          SENSORHUB15_RE
	{.adr=0x51,    .type=0x02},        //r                          SENSORHUB16_RE
	{.adr=0x52,    .type=0x02},        //r                          SENSORHUB17_RE
	{.adr=0x53,    .type=0x02},        //r                          SENSORHUB18_RE
	{.adr=0x54,    .type=0x02},        //r                          FUNC_SRC1
	{.adr=0x55,    .type=0xFF},        //-                          FUNC_SRC2
	{.adr=0x58,    .type=0x03},        //r/w                        RESERVED
	{.adr=0x59,    .type=0x03},        //r/w                        TAP_CFG
	{.adr=0x5A,    .type=0x03},        //r/w                        TAP_THS_6D
	{.adr=0x5B,    .type=0x03},        //r/w                        INT_DUR2
	{.adr=0x5C,    .type=0x03},        //r/w                        WAKE_UP_THS
	{.adr=0x5D,    .type=0x03},        //r/w                        WAKE_UP_DUR
	{.adr=0x5E,    .type=0x03},        //r/w                        FREE_FALL
	{.adr=0x5F,    .type=0x03},        //r/w                        MD1_CFG
	{.adr=0x60,    .type=0x03},        //r/w                        MD2_CFG
	{.adr=0x61,    .type=0x03},        //r/w                        MASTER_CMD_COD
	{.adr=0x62,    .type=0xFF},        //-                          RESERVED
	...
	{.adr=0x76,    .type=0xFF},        //-                          RESERVED
};
                                                                    //SENS_SYNC_SPI_ ERROR_CODE
	...
	if(/*L3gd20Drv.ReadID() ==*/ GyroAccDriverReg->ISM330DLC_Reg_Struct.WHO_AM_I)
	{
		for (index = 0; index < (sizeof(GyroAccDriverReg->ISM330DLC_Reg_Tab)/sizeof(GyroAccDriverReg->ISM330DLC_Reg_Tab[0])); index++)
		{
			if (0xFF != IMS330DLC_Reg_Type_Adr[index].adr)
			{
				...
				{
					//read
					Acc_Gyro_Imc330dlc_Read(&GyroAccDriverReg->ISM330DLC_Reg_Tab[index], IMS330DLC_Reg_Type_Adr[index].adr, Num);
